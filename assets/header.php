...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center bg-dark">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="<?php echo WEB_ROOT; ?>" class="logo d-flex align-items-center">
        <img src="assets/img/logo.png" alt="">
        <span class="d-none d-lg-block " style="color: white;">Anevie's Bakeshop</span>
      </a>
      ...
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item dropdown">
          ...
          <a class="nav-link nav-icon" href="#" data-bs-toggle="dropdown">
            ...
            <span class="badge bg-primary badge-number"><?php echo $_SESSION['user_id']; ?></span>
